...
export const createProductSchema = z.object({
  ...
  stock: z.number().optional().default(0).or(z.string().transform(v => Number(v))),
  ...
  variants: z.array(z.object({
    ...
    sku: z.string().optional().nullable(),
    price: z.number().min(0, "Price must be non-negative").optional().nullable().or(z.string().optional().transform(v => v ? Number(v) : null)),
    ...
    specialPriceStart: z.string().nullable().optional(),
    specialPriceEnd: z.string().nullable().optional(),
    stock: z.number().optional().default(0).or(z.string().transform(v => Number(v) || 0)),
    weight: z.string().optional().nullable(),
    image: z.string().optional().nullable(),
